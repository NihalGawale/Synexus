...
//       <Wrapper>
//         <section className="">
//           <h1 className="leading-[46px] text-[38px] lg:text-6xl font-extrabold pl-3 pr-10">
//             Unlocking the Power of Collaboration
//           </h1>
//           <p className="px-3 mt-4 font-medium text-xs lg:text-sm text-gray-500">
//             Introducing a dynamic collaboration nexus which serves as a marketplace where talent meets opportunity.
//           </p>
//         </section>
//       </Wrapper>
//       <Wrapper >
...
//         <Image fill objectFit="cover" src="/assets/handshake.jpg" alt="handshake-image" />
//         </div>
      ...
      <Box>
        <Wrapper>
          ...
          <p className="px-3 mt-4 text-center text-xs lg:text-lg font-medium text-[#7d7b7b] lg:px-36">
            ...
            <span className="text-[#1e1d1d] font-semibold">freelancers</span>{" "}
            and{" "}
