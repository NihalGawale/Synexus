...
const Header = () => {
  // const router
  return (
    <div className="  bg-[#f3f3f3] w-[100%] lg:w-[70%] p-3 lg:p-4 flex justify-center items-center text-3xl rounded-full font-semibold font border-b shadow-lg shadow-gray-500/30 cursor-pointer">
